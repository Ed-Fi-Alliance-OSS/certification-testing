...
join edfi.descriptor dpt on dpt.descriptorid = ptd.programtypedescriptorid
join edfi.student s on s.studentusi = spa.studentusi
join edfi.studentlanguageinstructionprogramassociationenglishlangu_1ac620 slpaelp on slpaelp.programeducationorganizationid = slpa.programeducationorganizationid
...
join edfi.studentlanguageinstructionprogramassociationlanguageinst_268e07 slpas on slpas.programeducationorganizationid = slpa.programeducationorganizationid
...
join edfi.studentmigranteducationprogramassociationmigranteducatio_d9dcd7 smpas on smpas.programeducationorganizationid = smpa.programeducationorganizationid
...
join edfi.studentneglectedordelinquentprogramassociationneglectedo_520251 sndpas on sndpas.programeducationorganizationid = sndpa.programeducationorganizationid
...
join edfi.descriptor dpt on dpt.descriptorid = ptd.programtypedescriptorid
join edfi.student s on s.studentusi = spa.studentusi
join edfi.studentschoolfoodserviceprogramassociationschoolfoodserv_85a0eb ssfpas on ssfpas.programeducationorganizationid = ssfpa.programeducationorganizationid
